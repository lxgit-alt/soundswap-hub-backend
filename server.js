...
app.use('/api/send-welcome-email', emailRoutes); // UPDATED
...
app.get('/', (req, res) => {
  res.json({
    ...
    email_services: {
      welcome: 'POST /api/send-welcome-email/send-welcome-email', // UPDATED
      password_reset: 'POST /api/send-welcome-email/send-password-reset', // UPDATED
      song_reviewed: 'POST /api/send-welcome-email/send-song-reviewed', // UPDATED
      test: 'GET /api/send-welcome-email/test' // UPDATED
    },
    reddit_automation: {
